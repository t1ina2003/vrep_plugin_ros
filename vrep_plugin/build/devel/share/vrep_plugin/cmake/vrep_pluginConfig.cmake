...
if("TRUE" STREQUAL "TRUE")
  set(vrep_plugin_SOURCE_PREFIX /home/iris/folder/vrep_plugin)
  set(vrep_plugin_DEVEL_PREFIX /home/iris/folder/vrep_plugin/build/devel)
  ...
  set(vrep_plugin_INSTALL_PREFIX /usr/local)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vrep_plugin' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/iris/folder/vrep_plugin/${idir}'.  Ask the maintainer 'Marc <marc@coppeliarobotics.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/iris/folder/vrep_plugin/build/devel/lib;/home/iris/folder/vrep_common/build/devel/lib;/opt/ros/jade/lib)
