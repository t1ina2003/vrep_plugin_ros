...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ForceSensorData>)))
  ...
  (cl:format cl:nil "std_msgs/Int32 sensorState~%geometry_msgs/Vector3 force~%geometry_msgs/Vector3 torque~%~%================================================================================~%MSG: std_msgs/Int32~%int32 data~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ForceSensorData)))
  "Returns full string definition for message of type 'ForceSensorData"
  (cl:format cl:nil "std_msgs/Int32 sensorState~%geometry_msgs/Vector3 force~%geometry_msgs/Vector3 torque~%~%================================================================================~%MSG: std_msgs/Int32~%int32 data~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%~%float64 x~%float64 y~%float64 z~%~%"))
